...
data_set= pd.read_csv('C:/Users/nican/GitCAProject/Multiroom/ProjectServer/MatriceSegnali2stanze.csv', header=None, delimiter=";",  skiprows=1)  

data_set= data_set.to_numpy()

n_samples, n_features= data_set.shape
n_features -=1
X= data_set[0:135,0:n_features]
Y= data_set[0:135,n_features]
